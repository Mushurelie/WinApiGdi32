...
namespace WinApiGdi32
{
    ...
    int fuWinIni
        ...
        [DllImport("user32.dll")] public static extern IntPtr GetDC(IntPtr hdcScr);
        ...
        [DllImport("gdi32.dll")] public static extern IntPtr SelectObject(IntPtr hdc, IntPtr handleObj);
        [DllImport("gdi32.dll")] public static extern bool DeleteObject(IntPtr handleObj);
        [DllImport("gdi32.dll")]
        ...
        [DllImport("gdi32.dll")] public static extern bool PatBlt(IntPtr hdc, int nXLeft, int nYLeft, int nWidth, int nHeight, TernaryRasterOperations dwRop);
        [DllImport("gdi32.dll")]
        ...
        [DllImport("gdi32.dll")]
        public static extern bool Pie(IntPtr hdc, int nLeftRect, int nTopRect, int nRightRect, int nBottomRect,
            int nXRadial1, int nYRadial1, int nXRadial2, int nYRadial2);
        [DllImport("gdi32.dll")] public static extern bool FillRgn(IntPtr hdc, IntPtr hrgn, IntPtr hbr);
        ...
        [StructLayout(LayoutKind.Sequential)]
        public struct GRADIENT_RECT { public uint UpperLeft; public uint LowerRight; }
        [StructLayout(LayoutKind.Sequential)]
        public struct TRIVERTEX { public int x, y; public ushort Red, Green, Blue, Alpha; }
        [StructLayout(LayoutKind.Sequential)]
        public struct GRADIENT_TRIANGLE { public uint Vertex1, Vertex2, Vertex3; }

        public enum Rop
        {
            BLACKNESS = 0x0, NOTSRCERASE = 0x001100A6, NOTSRCCOPY = 0x00330008, SRCERASE = 0x00440328,
            DSTINVERT = 0x00550009, PATINVERT = 0x005A0049, SRCINVERT = 00660046, SRCAND = 0x008800C6,
            MERGEPAINT = 0x00BB0226, MERGECOPY = 0x00C000CA, SRCCOPY = 0x00CC0020, SRCPAINT = 0x00EE0086,
            PATCOPY = 0x00F00021, PATPAINT = 0x00FB0A09, WHITENESS = 0x00FF0062
        }
        ...
        public enum TernaryRasterOperations : uint
        {
            ...
            DSTINVERT = 0x00550009, BLACKNESS = 0x00000042, WHITENESS = 0x00FF0062, CAPTUREBLT = 0x40000000, CUSTOM = 0x00100C85
        }
